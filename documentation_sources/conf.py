...
project = 'GENESIS Database API Wrapper'
copyright = '2022, Jan Eike Suchard'
release = '1.1.0'
author = 'Jan Eike Suchard'
github_username = 'j-suchard'
github_repository = 'destatis-genesis-api'


extensions = ['myst_parser', 'sphinx.ext.autodoc', 'sphinx.ext.githubpages',
              'sphinx.ext.intersphinx', 'enum_tools.autoenum', 'sphinx_toolbox.collapse',
              'sphinx_toolbox.github', 'sphinx_toolbox.shields', 'sphinx.ext.autosectionlabel',
