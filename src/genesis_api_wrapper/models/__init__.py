...
class CubeInformation(ObjectInformation):
    ...
    time_span: str = Field(default=..., alias="Time")
    """
    Time span
    ...
    last_update: int = Field(default=..., alias="LatestUpdate")
    """
    Last Update
    ...
    extra_information: bool = Field(default=..., alias="Information")
    """
    Extra Information
...
class StatisticInformation(ObjectInformation):
    ...
    cubes: int = Field(default=..., alias="Cubes")
    """
    Number of cubes
...
class TimeSeriesInformation(ObjectInformation):
    ...
    time_range: str = Field(default=..., alias="Time")
    """The time range available in the time series"""

    last_update: datetime = Field(default=..., alias="LatestUpdate")
...
class VariableInformation(ObjectInformation):
    ...
    values: int = Field(default=..., alias="Values")
    """
    Number of values
...
class JobInformation(ObjectInformation):
    ...
    job_date: date = Field(default=..., alias="Date")
    """
    Date Information
    ...
    job_time: time = Field(default=..., alias="Time")
    """
    Time Information
...
class ModifiedDataInformation(ObjectInformation):
    ...
    change_date: date = Field(default=..., alias="Date")
    """The date of the change"""

    added: str = Field(default=..., alias="Added")
...
class TermInformation(BaseModel):
    term: str = Field(default=..., alias="Content")
...
class ValueInformation(ObjectInformation):
    ...
    variables: int = Field(default=-1, alias="Variables")
