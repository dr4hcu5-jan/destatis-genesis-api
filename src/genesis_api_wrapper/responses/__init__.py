...
class BaseResponse(BaseModel):
    ...
    service_identification: ServiceIdent = Field(default=..., alias="Ident")
    """Information about the called service"""

    request_status: Status = Field(default=..., alias="Status")
    """Status information about the request"""

    request_parameter: RequestParameter = Field(default=..., alias="Parameter")
    """The request parameter which where sent to the server"""

    copyright_notice: str = Field(default=..., alias="Copyright")
...
class HelloWorld:
    class WhoAmIResponse(BaseModel):
        ...
        user_ip: str = Field(
            default=..., alias="User-IP", description="The IP address from which the call was made"
        )
...
class Find:
    ...
    class FindResult(BaseResponse):
        ...
        data_cubes: Optional[list[CubeInformation]] = Field(default=None, alias="Cubes")
        """A list of data cubes which matched the find request"""

        statistics: Optional[list[StatisticInformation]] = Field(default=None, alias="Statistics")
        "A list of statistics which matched with the find request"

        tables: Optional[list[TableInformation]] = Field(default=None, alias="Tables")
        """A list of tables which matched with the find request"""

        time_series: Optional[list[TimeSeriesInformation]] = Field(default=None, alias="Timeseries")
        """A list of time series which matched with the find request"""

        variables: Optional[list[VariableInformation]] = Field(default=..., alias="Variables")
...
class Catalogue:
    ...
    class CubeResponse(BaseResponse):
        ...
        cube_list: Optional[list[CubeInformation]] = Field(default=None, alias="List")

    class JobResponse(BaseResponse):
        """A response for getting a list of Jobs (e.g. getting big tables)"""

        job_list: Optional[list[JobInformation]] = Field(default=None, alias="List")
    ...
    class QualitySignsResponse(BaseResponse):
        ...
        quality_signs: Optional[list[QualitySignInformation]] = Field(default=None, alias="List")
    ...
    class ResultTableResponse(BaseResponse):
        ...
        result_tables: Optional[list[ResultTableInformation]] = Field(default=..., alias="List")
    ...
    class StatisticsResponse(BaseResponse):
        ...
        statistics: Optional[list[StatisticInformation]] = Field(default=None, alias="List")
    ...
    class TableResponse(BaseResponse):
        ...
        statistics: Optional[list[TableInformation]] = Field(default=None, alias="List")
        """Information about the found tables"""

    class TermResponse(BaseResponse):
        """A response containing a list of terms"""

        terms: Optional[list[TermInformation]] = Field(default=None, alias="List")

    class TimeseriesResponse(BaseResponse):
        time_series: Optional[list[TimeSeriesInformation]] = Field(default=None, alias="List")

    class ValueResponse(BaseResponse):
        time_series: Optional[list[ValueInformation]] = Field(default=None, alias="List")

    class VariableResponse(BaseResponse):
        variables: Optional[list[VariableInformation]] = Field(default=None, alias="List")
